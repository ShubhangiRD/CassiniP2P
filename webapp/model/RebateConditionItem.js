sap.ui.define([
	...
	"com/cassiniProcureToPay/model/Scale",
	"com/cassiniProcureToPay/service/dateServices",
	"com/cassiniProcureToPay/service/Application"
], function(BaseObject, Scale, dateServices, Application) {
	"use strict";
	var RebateConditionItem = BaseObject.extend("com.cassiniProcureToPay.model.RebateConditionItem", {

sap.ui.define([
	...
	return Controller.extend("com.cassiniProcureToPay.controller.LoginPage", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.cassiniProcureToPay.view.view.LoginPage
		 */
			onInit: function() {
		...
		onLogin: function() {
			...
			if(sUserName === "admin" && sPassword === "admin") {
				...
				return;
			} else if(sUserName === "cassini" && sPassword === "123") {
			
				var oRouter1 = this.getOwnerComponent().getRouter();
				oRouter1.navTo("AdminPanel");
